...
def  single_root_words (root_word, *other_words):
    ...
    for word in other_words:
        ...
        if word.find(root_word) >= 0: # Проверка, если слово из списка включает в себя проверочное слово.
            same_words.append(word)
        if root_word.find(word) >= 0: # Проверка, если проверочное слово включает в себя слово из списка.
           same_words.append(word)
